...
var thirdHero = heroes.slice(heroes.indexOf('batman'), heroes.indexOf('batman') + 1)[0];
...
function removeItem (arr, str) {
	var filArr = arr.filter((val) => val !== str);
	return filArr;
}
...
var getValueOfProperty = (obj, prop) => obj[prop];
...
var callerBack = (cb, param) => {
	return cb(param + ' back');
}
